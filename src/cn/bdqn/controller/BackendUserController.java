...
public class BackendUserController {
    ...
    public String doLogin(String userCode, String userPassword, HttpSession session, Model model){
        ...
        if (backendUser!=null){
            List<DataDictionary> dictionaryList = dataDictionaryService.findDataDictionaryList(Constants.USER_TYPE, backendUser.getUserType());
            if (dictionaryList!=null){
                backendUser.setUserTypeName(dictionaryList.get(0).getValueName());
            }
