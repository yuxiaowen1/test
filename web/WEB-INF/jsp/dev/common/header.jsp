        ...
        <div class="col-md-3 left_col menu_fixed">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="${pageContext.request.contextPath }/dev/user/main.html" class="site_title">
                        <i class="fa fa-paw"></i> <span>AppInfoSystem</span>
                    </a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> APP账户管理 <span
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="javascript:void(0);">APP开发者账户申请</a>
                                    </li>
                                    <li><a href="javascript:void(0);">个人账户信息维护</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> APP应用管理<span
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath }/dev/user/applist.html">APP维护</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class=""><a href="javascript:;"
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li>
                                    <a href="${pageContext.request.contextPath }/dev/logout.html">
                                        <i class="fa fa-sign-out pull-right"></i>注销</a>
                                </li>
                            </ul>
                        </li>
